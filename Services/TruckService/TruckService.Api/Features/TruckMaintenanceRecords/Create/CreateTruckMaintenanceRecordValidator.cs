...
public sealed class CreateTruckMaintenanceRecordValidator : AbstractValidator<CreateTruckMaintenanceRecordCommand>
{
    private static readonly string[] AllowedMaintenanceTypes = ["Preventive", "Corrective", "Tire Change", "Oil Change"];

    public CreateTruckMaintenanceRecordValidator()
    {
        RuleFor(x => x.TruckId)
